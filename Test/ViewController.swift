...
class ViewController: UIViewController {
    ...
    var ScreenX: CGFloat = 0.0//screen coordinate x
    var ScreenY: CGFloat = 0.0//screen coordinate y
    var MsgNum = 0//user messages total
    ...
    func SetMsgWidgetBackground(){
        var ImgBg = UIImageView(frame: CGRectMake(ScreenX*0.1, CGFloat(40 + 405*MsgNum), ScreenX*0.8, 400))
    ...
    func SetMsgWidgetHead(){
        var ImgHead = UIImageView(frame: CGRectMake((ScreenX*0.1)+2, CGFloat(42 + 405*MsgNum), 45, 45))
            ImgHead.image = UIImage(named: "male.jpg")
            self.view.addSubview(ImgHead)
    }
    //set messsage widget user Nick
    func SetMsgWidgetNick(){
        var LabNick = UILabel(frame: CGRectMake(90, CGFloat(52 + 405*MsgNum), 100, 20))
            LabNick.text = "tester"
            self.view.addSubview(LabNick)
    }
    //set message widget Image
    func SetMsgWidgetImgCont(){
        var ImgCont = UIImageView(frame: CGRectMake((ScreenX*0.1)+2, CGFloat(95 + 405*MsgNum), ScreenX*0.8 - 4, 200))
    ...
    func SetMsgWidgetImgDesc(){
        var TextCont = UITextView(frame: CGRectMake((ScreenX*0.1)+2, CGFloat(300 + 405*MsgNum), ScreenX*0.8 - 4, 50))
    ...
    func SetMsgWidgetVote(){
        var LabVote = UILabel(frame: CGRectMake((ScreenX*0.1)+2, CGFloat(365 + 405*MsgNum), ScreenX*0.8, 10))
            LabVote.text = "有用 100 － 没用 100  评论 100"
            self.view.addSubview(LabVote)
    }
    //set message widget Vote button
    func SetMsgWidgetVoteBtn(){
        var BtnGood = UIButton(frame: CGRectMake((ScreenX*0.1)+5, CGFloat(380 + 405*MsgNum), 40, 40))
        ...
        var BtnBad = UIButton(frame: CGRectMake((ScreenX*0.1)+85, CGFloat(380 + 405*MsgNum), 40, 40))
        ...
        var BtnComment = UIButton(frame: CGRectMake((ScreenX*0.1)+165, CGFloat(380 + 405*MsgNum), 40, 40))
    ...
    //set Navigation widget
    func SetNav(){
        var ImgNav = UIImageView(frame: CGRectMake(0, ScreenY - 45, ScreenX, 45))
            ImgNav.layer.backgroundColor = UIColor.redColor().CGColor
